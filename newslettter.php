					...
					<div class="col-md-12">
						...
						<div class="newsletter">
							...
							<ul class="newsletter-follow">
								<li>
									<a href="https://www.facebook.com/akustupidd"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://www.instagram.com/aku_stupidd"><i class="fa fa-instagram"></i></a>
								</li>
								<li>
									<a href="https://t.me/chanthangor"><i class="fa fa-telegram"></i></a>
								</li>
								<li>
									<a href="https://github.com/akustupidd"><i class="fa fa-github"></i></a>
								</li>
							</ul>
						</div>
					</div>
